...
constexpr auto qt_meta_stringdata_CLASSGameLogicENDCLASS = QtMocHelpers::stringData(
    "GameLogic",
    "gameEnded",
    "",
    "spawnBlock",
...
void GameLogic::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->spawnBlock(); break;
        case 2: _t->moveBlocks(); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &GameLogic::gameEnded; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
